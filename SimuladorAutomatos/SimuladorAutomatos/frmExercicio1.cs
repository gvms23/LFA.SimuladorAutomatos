...
namespace SimuladorAutomatos
{
    public partial class frmExercicio1 : Form
    {
        ...
        private void btnSolucao_Click(object sender, EventArgs e)
        {
            ...
            txtLog.Text += "Lógica: L (M) = {w ∈ {0,1} | w inicia em 0 e termina em 1}" + Environment.NewLine;
            ...
            for (i = 0; i < quantidadeCaracteresEntrada; i++)
            {
                    ...
                    case "q0":
                        {
                            ...
                            if (charEntrada[i] == '1')
                            {
                                MessageBox.Show("A entrada deve iniciar com 0", "Rejeição", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    ...
                    case "q1":
                        {
                            ...
                            if (charEntrada[i] == '0')
                            {
                                ...
                                txtLog.Text += "Estado: q1 | Entrada: 0 | Ação: Permaneço no q1." + Environment.NewLine;

                                if (chkPassoApasso.Checked == true)
                                {
                                    MessageBox.Show("Estado: q1 | Entrada: 0 | Ação: Permaneço no q1.", "Passo a Passo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                                }
                            ...
                            else if (charEntrada[i] == '1')
                            {
                                ...
                                txtLog.Text += "Estado: q1 | Entrada: 1 | Ação: Vou para q2." + Environment.NewLine;

                                if (chkPassoApasso.Checked == true)
                                {
                                    MessageBox.Show("Estado: q1 | Entrada: 1 | Ação: Vou para q2.", "Passo a Passo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                                }
                    ...
                    case "q2":
                        {
                            ...
                            if (charEntrada[i] == '0')
                            {
                                ...
                                txtLog.Text += "Estado: q2 | Entrada: 0 | Ação: Volto para q1." + Environment.NewLine;

                                if (chkPassoApasso.Checked == true)
                                {
                                    MessageBox.Show("Estado: q2 | Entrada: 0 | Ação: Volto para q1.", "Passo a Passo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                                }
                            ...
                            else if (charEntrada[i] == '1')
                            {
                                ...
                                if (contagemQuantasVezesNoQ2 == 1)
                                {
                                    txtLog.Text += "Estado: q2 | Entrada: 1 | Ação: Estado Final" + Environment.NewLine;

                                    if (chkPassoApasso.Checked == true)
                                    {
                                        MessageBox.Show("Estado: q2 | Entrada: 1 | Ação: Estado Final", "Passo a Passo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                                    }
                                }

                                if (contagemQuantasVezesNoQ2 > 1)
                                {
                                    txtLog.Text += "Estado: q2 | Entrada: 1 | Ação: Permaneço em q2." + Environment.NewLine;

                                    if (chkPassoApasso.Checked == true)
                                    {
                                        MessageBox.Show("Estado: q2 | Entrada: 1 | Ação: Permaneço em q2.", "Passo a Passo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                                    }
                                }
                            }
                ...
                {
                    if (estadoAtual == "q2" && charEntrada[i] == '1')
                    {
                        ...
                        txtLog.Text += "Terminou no estado q2 e com entrada 0, parabéns!" + Environment.NewLine;
                        MessageBox.Show("Terminou no q2 e com a entrada 0, parabéns!", "Entrada Aceita", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    ...
                    else
                    {
                        ...
                        txtLog.Text += "Rejeitado, não terminou no q2 e com a entrada 0" + Environment.NewLine;
                        MessageBox.Show("Rejeitado, não terminou no q2 e com a entrada 0", "Entrada Rejeitada", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    }
                }
        ...
        private void irParaOOutroExercícioToolStripMenuItem_Click(object sender, EventArgs e)
        {
            abreFormExercicio2();
        }
